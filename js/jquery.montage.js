...
(function( window, $, undefined ) {
	...
	*/
	...
	$.Montage.defaults 			= {
		...
		margin					: 5,	// space between images. (default:1)
		minw					: 175,	// the minimum width that a picture should have.  (default:70)
		minh					: 20,	// the minimum height that a picture should have. (default:20)
	...
	$.Montage.prototype 		= {
		...
		_cropImage			: function( $img, w, h, cropParam ) {
			...
			// wrap the image in .img class element
